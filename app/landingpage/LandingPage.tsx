...
export default function LandingPage() {
  return (
    <div className="lp">
      ...
      <link
        href="https://fonts.googleapis.com/css2?family=Inter+Tight:wght@500;600;700;800&family=Inter:wght@400;500;600&family=JetBrains+Mono:wght@500;600&display=swap"
        rel="stylesheet"
      />
        ...
        <section id="untuk-siapa">
          <div className="wrap">
            ...
            <div className="audience-grid">
              {AUDIENCE.map((a, i) => (
                <Reveal key={a.tag} delay={i * 60} className="audience-card">
        ...
        <section id="masalah">
          <div className="wrap">
            ...
            <div className="pains">
              ...
              <Reveal delay={60} className="pain">
              ...
              <Reveal delay={120} className="pain">
          ...
          <div className="wrap">
            <Reveal className="spotlight">
              ...
              <div className="heat-panel">
                ...
                <div className="heat-banner">62% pasien lama balik sebelum 90 hari — retensi klinik Anda di atas rata-rata.</div>
              </div>
            </Reveal>
          </div>
        </section>
        ...
        <section id="onboarding">
          <div className="wrap">
            ...
            <div className="steps">
              ...
              <Reveal delay={60} className="step">
...
function heatOpacity(row: number, col: number): number {
  ...
  const value = Math.min(0.95, Math.max(0.06, base * (0.7 + row * 0.12) + jitter * 0.15));
  // Fixed precision keeps the SSR and client string output byte-identical — Math.sin can
  // otherwise differ in its last few decimal digits between the server and browser JS engines,
  // which React flags as a hydration mismatch on this inline custom property.
